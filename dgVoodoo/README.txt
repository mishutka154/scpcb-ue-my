If you experience a MAV error during loading/launching the game (or low FPS), and the video driver name in the error window includes terms like "Primary Driver" or "UHD Graphics [number]"
