...
Const NPC_CLASS_D_BODY_1_TEXTURE% = 11
Const NPC_CLASS_D_BODY_2_TEXTURE% = 12
Const NPC_CLASS_D_VICTIM_035_TEXTURE% = 13
Const NPC_CLASS_D_VICTIM_409_TEXTURE% = 14
Const NPC_CLASS_D_VICTIM_939_1_TEXTURE% = 15
Const NPC_CLASS_D_VICTIM_939_2_TEXTURE% = 16
Const NPC_CLASS_D_VICTIM_FEMUR_BREAKER_TEXTURE% = 17

Const NPC_CLERK_VICTIM_205_TEXTURE% = 18
Const NPC_CLERK_TESLA_TEXTURE% = 19

Const NPC_173_TESLA_TEXTURE% = 20
Const NPC_999_TESLA_TEXTURE% = 21
;[End Block]
