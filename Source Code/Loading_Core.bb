...
Function LoadItems%()
	...
	CreateItemTemplate(GetLocalString("items", "papn_1"), "Paper From Nobody #1", it_paper, "paper.b3d", "INV_note.png", "Paper_Nobody(0).png", 0.0025, 0, "Paper_Nobody(0).png")
	CreateItemTemplate(GetLocalString("items", "papn_2"), "Paper From Nobody #2", it_paper, "paper.b3d", "INV_note.png", "Paper_Nobody(1).png", 0.0025, 0, "Paper_Nobody(1).png")
	CreateItemTemplate(GetLocalString("items", "papn_3"), "Paper From Nobody #3", it_paper, "paper.b3d", "INV_note.png", "Paper_Nobody(2).png", 0.0025, 0, "Paper_Nobody(2).png")
	CreateItemTemplate(GetLocalString("items", "papn_4"), "Paper From Nobody #4", it_paper, "paper.b3d", "INV_note.png", "Paper_Nobody(3).png", 0.0025, 0, "Paper_Nobody(3).png")
	CreateItemTemplate(GetLocalString("items", "papn_5"), "Paper From Nobody #5", it_paper, "paper.b3d", "INV_note.png", "Paper_Nobody(4).png", 0.0025, 0, "Paper_Nobody(4).png")
	...
	CreateItemTemplate("SCP-005", "Coarse SCP-005", it_coarse005, "scp_005.b3d", "INV_scp_005.png", "", 0.0003, 1)
	CreateItemTemplate("SCP-005", "Fine SCP-005", it_fine005, "scp_005.b3d", "INV_scp_005.png", "", 0.0002, 1)
...
Function LoadEntities%()
	...
	Tex = CreateTextureUsingCacheSystem(SMALLEST_POWER_TWO_HALF, SMALLEST_POWER_TWO_HALF, 1 + 2 + (256 * opt\SaveTexturesInVRAM), 1, DeleteMapTextures) ; ~ LIGHT
