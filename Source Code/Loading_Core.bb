...
Const MaxNPCModelIDAmount% = 33 ;33
Const MaxNPCTextureID% = 29 ;29
...
Const NPC_CLASS_D_VICTIM_035_TEXTURE% = 17
Const NPC_CLASS_D_VICTIM_035_CORPSE_TEXTURE% = 18
Const NPC_CLASS_D_VICTIM_106_TEXTURE% = 19
Const NPC_CLASS_D_VICTIM_106_FEMUR_BREAKER_TEXTURE% = 20
Const NPC_CLASS_D_VICTIM_409_TEXTURE% = 21
Const NPC_CLASS_D_VICTIM_939_1_TEXTURE% = 22
Const NPC_CLASS_D_VICTIM_939_2_TEXTURE% = 23
Const NPC_CLASS_D_VICTIM_FEMUR_BREAKER_TEXTURE% = 24

Const NPC_CLERK_VICTIM_205_TEXTURE% = 25
Const NPC_CLERK_TESLA_TEXTURE% = 26

Const NPC_173_TESLA_TEXTURE% = 27

Const NPC_999_TESLA_TEXTURE% = 28
;[End Block]
