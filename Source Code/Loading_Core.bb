...
Type SecurityCamInstance
	Field CamModelName$[MaxCamModelIDAmount]
...
Function LoadSecurityCams%()
	...
	sc_I\CamModelName[CAM_BASE_MODEL] = "CamBase"
	sc_I\CamModelName[CAM_HEAD_MODEL] = "CamHead"
...
Const NPC_CLASS_D_BODY_1_TEXTURE% = 14
Const NPC_CLASS_D_BODY_2_TEXTURE% = 15
Const NPC_CLASS_D_VICTIM_035_TEXTURE% = 16
Const NPC_CLASS_D_VICTIM_035_CORPSE_TEXTURE% = 17
Const NPC_CLASS_D_VICTIM_106_TEXTURE% = 18
Const NPC_CLASS_D_VICTIM_106_FEMUR_BREAKER_TEXTURE% = 19
Const NPC_CLASS_D_VICTIM_409_TEXTURE% = 20
Const NPC_CLASS_D_VICTIM_939_1_TEXTURE% = 21
Const NPC_CLASS_D_VICTIM_939_2_TEXTURE% = 22
Const NPC_CLASS_D_VICTIM_FEMUR_BREAKER_TEXTURE% = 23

Const NPC_CLERK_VICTIM_205_TEXTURE% = 24
Const NPC_CLERK_TESLA_TEXTURE% = 25

Const NPC_173_TESLA_TEXTURE% = 26

;Const NPC_999_TESLA_TEXTURE% = 27
;[End Block]
